...
local plugins = {
  ...
  -- cmp plugins
  { "hrsh7th/nvim-cmp",                  commit = "b0dff0ec4f2748626aae13f011d1a47071fe9abc", config = conf('cmp') },
  ...
  { "RRethy/vim-illuminate",             commit = "a2e8476af3f3e993bb0d6477438aad3096512e42", config = conf('illuminate') },
